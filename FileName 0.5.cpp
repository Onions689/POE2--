...
static wstring ToSimplified(const wstring& trad) {
    static map<wstring, wstring> tradToSimp = {
        {L"獵場",L"猎场"},{L"纏縛陰林",L"缠缚阴林"},{L"奧格姆農地",L"奥格姆农地"},
        ...
        {L"莫頓挖石場",L"莫顿挖石场"},{L"叛徒之路",L"叛徒之路"},{L"哈拉妮關口",L"哈拉妮关口"},
        {L"乳齒象惡地",L"乳齿象恶地"},{L"骨坑",L"骨坑"},{L"凱斯城",L"凯斯城"},
        {L"失落之城",L"失落之城"},{L"掩埋神殿",L"掩埋神殿"},{L"泰坦之谷",L"泰坦之谷"},
        {L"泰坦石窟",L"泰坦石窟"},{L"戴斯哈",L"戴斯哈"},{L"戴斯哈尖塔",L"戴斯哈尖塔"},
        {L"風沙沼澤",L"风沙沼泽"},{L"叢林遺跡",L"丛林遗迹"},{L"劇毒墓穴",L"剧毒墓穴"},
        {L"感染荒地",L"感染荒地"},{L"阿札克泥沼",L"阿札克泥沼"},{L"龍蜥濕地",L"龙蜥湿地"},
        ...
        {L"漆黑密室",L"漆黑密室"},{L"凱吉灣",L"凯吉湾"},{L"旅程之末",L"旅程之末"},
        {L"伯勞鳥之島",L"伯劳鸟之岛"},{L"悉妮蔻拉之眼",L"悉妮蔻拉之眼"},{L"亡者之殿",L"亡者之殿"},
        {L"金氏島",L"金氏岛"},{L"火山迷窟",L"火山迷窟"},{L"瓦卡帕努島",L"瓦卡帕努岛"},
        {L"吟謠洞窟",L"吟谣洞窟"},{L"廢棄監獄",L"废弃监牢"},{L"單獨禁閉室",L"单独禁闭室"},
        {L"阿拉塔斯",L"阿拉塔斯"},{L"挖掘",L"挖掘"},{L"尼加卡努",L"尼加卡努"},
        {L"部族之心",L"部族之心"},{L"火噬農地",L"火噬农地"},{L"瑟雷之石",L"瑟雷之石"},
        {L"黑木林",L"黑木林"},{L"霍爾登",L"霍尔登"},{L"狼之要塞",L"狼之要塞"},
        {L"霍爾登宅第",L"霍尔登宅第"},{L"卡里交匯道",L"卡里交汇道"},{L"卡塔爾之塘",L"卡塔尔之塘"},
        {L"塞爾卡里庇護所",L"塞尔卡里庇护所"},{L"賈萊關口",L"贾莱关口"},{L"奇瑪",L"奇玛"},
        {L"奇瑪水源地",L"奇玛水源地"},{L"灰燼森林",L"灰烬森林"},{L"庫萊亞村",L"库莱亚村"},
        {L"冰川湖泊",L"冰川湖泊"},{L"狂嗥洞穴",L"狂嗥洞穴"},{L"庫萊亞山巔",L"库莱亚山巅"},
        {L"蝕刻溪谷",L"蚀刻溪谷"},{L"庫阿西克寶庫",L"库阿西克宝库"}
    };
...
static void initializeChapters() {
    ...
    ch1.entries = {
        {L"皆伐", L"击杀BOSS贝拉获得+10%冰冷抗性", L"神秘营地开宝箱，1级技能石，蜕变石"},
        {L"泥沼陋居", L"击杀BOSS回城交任务，1级辅助宝石", L"增幅石"},
        {L"葛瑞爾林", L"击杀女巫给1级辅助宝石", L"无"},
        {L"赤谷", L"找到3个方尖碑并完成，回城提交任务", L"2级未切割技能宝石"},
        {L"纏縛陰林", L"击杀BOSS获得1级辅助宝石", L"3级未切割技能宝石"},
        {L"不朽帝國之墓", L"开宝箱获得1个随机戒指", L"富豪石"},
        {L"配偶的墓室", L"击杀boss配偶获取任务道具", L"随机普通品质护身符"},
        {L"政務官陵墓", L"击杀boss执政官获取任务道具", L"随机次级符文"},
        {L"猎场", L"【必拿】击杀BOSS巨鸦，获得2点天赋点", L"崇高石"},
        {L"弗雷索恩", L"【必拿】完成3个祭坛，击杀最后BOSS，获得30精魂", L"1级未切割辅助宝石"},
        {L"奥格姆农地", L"【必拿】找到乌娜的家，回城提交任务，获得2点天赋", L"4级未切割技能宝石"},
        {L"奥格姆村", L"找到工具回城提交解锁分解台", L"工匠石"},
        {L"宅第壁垒", L"解救囚犯获得1级辅助宝石", L"5级未切割技能宝石"},
        {L"奥格姆宅第", L"【必拿】第一层击杀BOSS烛火，获得20最大生命", L"点金石"}
    };
    chapterMap[1] = ch1;
    ...
    ch2.entries = {
        {L"瓦斯提里郊區", L"找到BOSS催债魔击杀", L"崇高石"},
        {L"莫頓挖石場", L"找到莫丹矿场进入击杀BOSS解救NPC", L"5级未切割精魂宝石"},
        {L"叛徒之路", L"【必拿】找到BOSS芭芭拉击杀，解锁升华1", L"工匠石"},
        {L"哈拉妮關口", L"找到BOSS击杀", L"崇高石"},
        {L"乳齒象惡地", L"找到暗光走廊解锁深渊工艺", L"富豪石"},
        {L"骨坑", L"打怪掉落任务道具，找到BOSS击杀", L"崇高石"},
        {L"凱斯城", L"【必拿】击杀BOSS蛇女，获得2点天赋", L"宝石匠棱镜"},
        {L"失落之城", L"找到掩埋的殿堂进入", L"点金石"},
        {L"掩埋神殿", L"元素神殿给对应抗性的戒指", L"低级工匠石【一定要拿】"},
        {L"泰坦之谷", L"找到3个封印激活", L"随机暗金装备"},
        {L"泰坦石窟", L"击杀BOSS神威巨像", L"机会石碎片"},
        {L"戴斯哈", L"找到遗体互动获得遗书，获得2点天赋", L"随机符文"},
        {L"戴斯哈尖塔", L"【必拿】获得+10闪电抗性", L"宝石匠棱镜"}
    };
    chapterMap[2] = ch2;
    ...
    ch3.entries = {
        {L"風沙沼澤", L"找到篝火营地开箱子", L"3级未切割辅助宝石"},
        {L"叢林遺跡", L"【必拿】击杀BOSS神威银拳，获得2点天赋", L"点金石"},
        {L"劇毒墓穴", L"找到骸蛇毒液回城对话", L"随机戒指"},
        {L"感染荒地", L"第三章地图岔路很多，逐一探索", L"崇高石"},
        {L"阿札克泥沼", L"【必拿】击杀BOSS获得30精魂", L"随机符文"},
        {L"龍蜥濕地", L"找到混沌神殿解锁升华2", L"9级未切割技能宝石"},
        {L"吉卡尼的機械迷城", L"【必拿】获得+10%火焰抗性", L"工匠石"},
        {L"吉卡尼的聖域", L"找到2个灵核激活发电机", L"崇高石"},
        {L"瑪特蘭水道", L"拉杆走到最后", L"10级未切割精魂宝石"},
        {L"淹沒之城", L"沿着马路走到污秽巅峰", L"3级未切割辅助宝石"},
        {L"熔岩寶庫", L"击杀BOSS获得重铸台", L"随机暗金装备"},
        {L"污垢頂峰", L"击杀BOSS污秽女王", L"瓦尔宝珠"},
        {L"科佩克神殿", L"找到BOSS击杀进入崎点", L"11级未切割精魂宝石"},
        {L"奧札爾", L"【必拿】完成献祭获得2点天赋", L"随机珠宝"},
        {L"漆黑密室", L"击杀关底BOSS结束第三章", L"瓦尔宝珠"}
    };
    chapterMap[3] = ch3;
    ...
    ch4.entries = {
        {L"凱吉灣", L"第四章任务非线性，找到旅途终点进入", L"崇高石"},
        {L"旅程之末", L"【必拿】获得2点天赋", L"点金石"},
        {L"伯勞鳥之島", L"找到BOSS击杀，解锁辛格拉之眼", L"4级未切割辅助宝石"},
        {L"悉妮蔻拉之眼", L"完成3个试炼，获得5%最大魔力", L"混沌石"},
        {L"亡者之殿", L"【必拿】获得2点天赋", L"随机符文"},
        {L"金氏島", L"找到熔火院落进入", L"宝石匠棱镜"},
        {L"火山迷窟", L"找到BOSS击杀", L"4级未切割辅助宝石"},
        {L"瓦卡帕努島", L"找到冥曲洞窟进入", L"工匠石"},
        {L"吟謠洞窟", L"找到蚌壳获得珍珠，换全抗项链", L"随机护符"},
        {L"廢棄監獄", L"杀怪掉落教堂钥匙", L"崇高石"},
        {L"單獨禁閉室", L"找到BOSS击杀", L"随机符文"},
        {L"阿拉塔斯", L"击杀BOSS进入挖掘场", L"12级未切割技能宝石"},
        {L"挖掘", L"找到并击杀BOSS", L"随机稀有护身符"},
        {L"尼加卡努", L"赛季玩法奖励一定要拿", L"高阶工匠石"},
        {L"部族之心", L"击杀BOSS对话回城第四章结束", L"12级未切割精魂宝石"}
    };
    chapterMap[4] = ch4;

    // 间奏一
    ChapterData i1;
    i1.title = L"间奏一章 / Interlude A1";
    i1.entries = {
        {L"火噬農地", L"找到BOSS击杀，找到黑暗入口", L"4级未切割辅助宝石"},
        {L"瑟雷之石", L"找到6个石柱激活，击杀中间BOSS", L"崇高石"},
        {L"黑木林", L"找到霍尔顿进入", L"高阶蜕变石"},
        {L"霍爾登", L"找到狼堡进入", L"随机高阶符文"},
        {L"狼之要塞", L"【必拿】击杀BOSS获得2点天赋", L"高阶增幅石"},
        {L"霍爾登宅第", L"击杀BOSS回城前往下一章", L"工匠石"}
    };
    chapterMap[5] = i1;

    // 间奏二
    ChapterData i2;
    i2.title = L"间奏二章 / Interlude A2";
    i2.entries = {
        {L"卡里交匯道", L"【必拿】获得2点天赋", L"宝石匠棱镜"},
        {L"卡塔爾之塘", L"进入塞卡莉圣所", L"点金石"},
        {L"塞爾卡里庇護所", L"找到BOSS击杀", L"机会石"},
        {L"賈萊關口", L"找到BOSS击杀进入奇玛尔", L"高阶增幅石"},
        {L"奇瑪", L"地图边缘7个柱子选属性", L"崇高石"},
        {L"奇瑪水源地", L"击杀BOSS王子", L"高阶蜕变石"}
    };
    chapterMap[6] = i2;

    // 间奏三
    ChapterData i3;
    i3.title = L"间奏三章 / Interlude A3";
    i3.entries = {
        {L"灰燼森林", L"找到克里亚村进入", L"随机稀有腰带"},
        {L"庫萊亞村", L"【必拿】击杀BOSS获得40精魂", L"随机高阶符文"},
        {L"冰川湖泊", L"击杀BOSS进入克里亚峰", L"高阶增幅石"},
        {L"狂嗥洞穴", L"【必拿】击杀BOSS获得2点天赋", L"混沌石"},
        {L"庫萊亞山巔", L"找到长老领取暗金装备", L"高阶蜕变石"},
        {L"蝕刻溪谷", L"击杀BOSS进入库阿奇克宝库", L"崇高石"},
        {L"庫阿西克寶庫", L"【必拿】最后2点天赋", L"瓦尔宝珠"}
    };
    chapterMap[7] = i3;

    for (int i = 1; i <= 7; i++) {
        for (const auto& entry : chapterMap[i].entries) {
            wstring guide = entry.storyReward + L"\n赛季玩法掉落：" + entry.seasonReward;
